 ...
 * @author PKom
 */
class RegionController extends OrganizationController {

    /**
     * @Route("/organization/regions_stat", name="app_regions_stats")
     */
    public function regionsStat() {
        $start = $this->getStartDateForFilter();
        $end = $this->getEndDateForFilter();
        $rows = $this->getDoctrine()->getRepository(\App\Entity\Region::class)->getEidRegionsStats($start, $end);
        return $this->render('organization/region/tab_stats_region.html.twig', [
                    'stats' => $rows,
        ]);
    }

    /**
     * @Route("/organization/region/district_outcomes/{region_id?0}", name="app_reg_districts_outcomes",requirements={"region_id"="-?\d+"})
     */
...
//prepare series data
    ...
    /**
     * @Route("/organization/region/overview", name="app_regions_overview")
     */
    ...
    /**
     * @Route("/organization/region/trends/{region_id?0}", name="app_region_trends",requirements={"region_id"="\d+"})
     */
...
//prepare series data
    ...
    /**
     * @Route("/organization/region/outcomes/{region_id?0}", name="app_region_outcomes",requirements={"region_id"="\d+"})
     */
...
//        die();
    ...
    /**
     * @Route("/organization/region/outcomes_age/{region_id?0}", name="app_region_outcomes_age",requirements={"region_id"="\d+"})
     */
